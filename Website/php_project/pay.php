...
<head>
    ...
    <title>CHECKOUT of TOOL STEADY WEBSTORE</title>
    <! -- title name -->
...
<style>
    * {
    ...
    .container {
        ...
        padding: 25px;
        min-height: 90vh;
        background: linear-gradient(90deg, #6a6e6c 60%, #151616 40.1%);
    ...
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li id="shopping-bag"><a class="active" href="cart.php"><i class="fa fa-shopping-bag"
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="inputBox">
                            ...
                            <input type="text" placeholder="mr. Edward">
                        </div>
                        <div class="inputBox">
